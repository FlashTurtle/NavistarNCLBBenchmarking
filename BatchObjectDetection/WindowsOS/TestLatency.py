...
folder_path = 'E:\\Storage\\Code\\Navistar\\BatchObjectDetection\\WindowsOS\\LogTest'#Edit to your path
door_model_path = 'E:\\Storage\\Code\\Navistar\\BatchObjectDetection\\WindowsOS\\doormodel.tflite' #Edit to your path

#folder_path = '/home/flashturtle/Desktop/BenchmarkProject/Log'#Edit to your path
#door_model_path = '/home/flashturtle/Desktop/BenchmarkProject/doormodel.tflite'#Edit to your path
...
#image_time_list = [["Image No.","Time To Complete","Total Time"]]
for image in procesed_image_list:
    ...
    #image_time_list.append(["Image #%.0f"%(count),get_time(start_time,end_time),total_time])
...
workbook.save("E:\\Storage\\Code\\Navistar\\BatchObjectDetection\\WindowsOS\\"+"PCoutput.xlsx")
#workbook.save("/home/flashturtle/Desktop/BenchmarkProject/"+"PIoutput.xlsx")
